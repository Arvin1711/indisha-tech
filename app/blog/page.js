...
const featuredPost = {
  ...
  readTime: "4 min read",
  excerpt:
    "Explore how SaaS platforms are reshaping business operations and enabling new levels of operational efficiency across industries.",
};
...
const recentPosts = [
  ...
  },
  {
    ...
    excerpt:
      "Explore the principles and techniques that drive user-centric UI design, ensuring a seamless and in...",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Delve into the realm of emotional design and discover how incorporating empathy and psychol...",
    image:
      "https://images.unsplash.com/photo-1497366754035-f200586c559f?auto=format&fit=crop&w=700&q=80",
    author: "Ryan A.",
    avatar:
  ...
  },
  {
    ...
    excerpt:
      "From glassmorphism to AI-powered interfaces, these are the design trends shaping the next wave of digital experiences.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "A deep dive into how design systems empower teams to deliver consistent, high-quality products faster.",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Understanding color psychology and application can dramatically improve user engagement and brand recall.",
    image:
      "https://images.unsplash.com/photo-1541707578-a5c2f7b6e3e0?auto=format&fit=crop&w=700&q=80",
    author: "Amelia Zhang",
    avatar:
        ...
        >
          <div className="py-16 text-center">
            <h1 className="mx-auto mt-16 max-w-5xl text-[36px] font-normal leading-[0.99] tracking-[-0.07em] text-[#0d0f17] sm:text-[60px] sm:leading-[0.99] sm:tracking-[-0.07em] md:text-[58px] lg:text-[58px] xl:text-[58px]">
              ...
              <span className="inline-block">From Our </span>
            ...
            {/* <h1 className="text-[44px] font-semibold leading-[0.99] tracking-[-0.07em] text-[#0d0f17] sm:text-[53px] md:text-[68px] lg:text-[68px] xl:text-[72px]">
              <span className="font-[Georgia,serif] font-normal italic text-[#f08c54]">
                Insights
              </span>{" "}
              &amp; Ideas
              <br />
            ...
            <p className="mx-auto mt-5 max-w-150 text-[14px] leading-[1.7] text-(--muted-color) sm:mt-6 sm:text-[16px]">
              Explore articles on design, technology, finance, and product
              strategy — written by practitioners building the future.
            </p>
          </div>
        </section>
        {/* ── Hero / Featured Post ── */}
              ...
              <div className="flex flex-col justify-between rounded-2xl bg-transparent p-1 sm:p-2">
                <div>
                  <div className="mb-5 flex items-center gap-2">
                    <span className="text-[11px] font-semibold tracking-[0.22em] text-[#ff6f9f]">
                      ● CFO
                    </span>
                  ...
                  <p className="mt-4 max-w-[30ch] text-[13px] leading-relaxed text-white/55">
                    Get videos, podcasts, and expert interviews featuring modern
                    finance leaders.
                  </p>
                </div>
                <Link
